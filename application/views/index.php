            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
                <div class="heigth">
                    <div class="verticalcenter">
                        ...
                        <p class="Text">
                          We've chosen a simple weather API that will give you the weather forecast of the week on your phone,
                          and the weather of the upcoming hour on your BiKE display. With this feature you will always be updated
                          with the upcoimg weather. So that if you are planning to make a trip, you can always move your trip an hour.
                          Or not, it's not always bad weather...</br></br>

                          VOiCE also will always tell you if it is going to rain within the next hour. Which is nice because you can
                          look for cover so you won't get wet. <i>we've got you covered, get it.</i>
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-6 col-sm-12 col-xs-12">
                <div class="heigth">
                    <div class="verticalcenter">
                        ...
                        <p class="Text">
                          The nature part is simple, don't take your headphones with you. (But please, always do, othterwise VOiCE will
                          never be able to talk to you :( )</br>
                          The Music part is actually pretty simple too. With your Bluetooth connection, your music on your phone
                          is automaticly synced with BiKE. Just go ahead and make a nice headbanging playlist in the BiKE app and you are ready to go.
                        </br></br>
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
                <div class="heigth">
                    <div class="verticalcenter">
                        ...
                        <p class="Text">
                          With our own made tire pressure sensors in both BiKEs wheels you're able to see your current
                          tire pressure on the BiKE display. Within the app you can see the detailed information of your tire pressure
                          from the beginning, to the end of your trip. So if you're losing your air alot faster than it should be,
                          You will still have a flat tire, it only is'nt a surprise anymore.
                        </br></br>
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-6 col-sm-12 col-xs-12">
                <div class="heigth">
                    <div class="verticalcenter">
                        ...
                        <p class="Text">
                          When your phone leaves the area within 5 meters of your BiKE, it automaticly locks and shuts down.
                          It saves alot of power and you don't even need to remember anything. The moment you will get in range of your
                          BiKE again, it will open up for you. You can always manually lock the bike if you want, but that is so 2009.
                        </br></br>
                          With the power of technology, we know when the sun will go down at your location. So when that happens
                          your light will automaticly turn on. No sensors needed, talk about power efficiency.
                        </p>
                      </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
                <div class="heigth">
                    <div class="verticalcenter">
                        ...
                        <p class="Text">
                          BiKE measures your heartrate by means of a heartrate sensor in your left handle. It transfers the information
                          to your phone, where you can watch your heartrate from the beginning of your trip, all the way to the end.
                          The BiKE display on the other hand, can show you your current heartrate at the given moment.
                        </br></br>
